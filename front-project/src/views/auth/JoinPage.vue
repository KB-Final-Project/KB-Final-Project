        ...
        <div class="w-100" style="max-width: 526px;">
          ...
          <form class="needs-validation" @submit.prevent="join" novalidate>
            <div class="row row-cols-1 row-cols-sm-2">
              ...
              <div class="col mb-4">
                <input v-model="member.id" class="form-control form-control-lg ps-5" type="text" placeholder="아이디를 입력하세요" required>
              </div>
            </div>
            <div class="password-toggle mb-4">
              <input v-model="member.email" class="form-control form-control-lg ps-5" type="email" placeholder="이메일을 입력하세요" required>
            </div>
            <div class="password-toggle mb-4">
              <input v-model="member.password" class="form-control form-control-lg ps-5" type="password" placeholder="비밀번호를 입력하세요" required>
            ...
            <div class="password-toggle mb-4">
              <input v-model="member.password2" class="form-control form-control-lg ps-5" type="password" placeholder="비밀번호를 확인하세요" required>
              <label class="password-toggle-btn" aria-label="Show/hide password">
                <input class="password-toggle-check" type="checkbox">
                <span class="password-toggle-indicator"></span>
              </label>
