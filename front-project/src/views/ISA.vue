<template>
  <div class="container text-center" style="transform: scale(0.9)">
    <div
      style="
        display: flex;
        align-items: center;
    ...
    >
      <div
        style="
          ...
          font-size: 26.5px; /* 글자 크기 키움 */
          font-weight: 400;
          margin-top: 35px;
        "
      >
        두 유형 모두 세제 혜택이 있으며, 자산의 종류와 운용 방식에 따라 투자자가
        선택할 수 있습니다.
      </div>
    </div>
    ...
    >
      ...
      >
        ...
        <span style="display: block; text-align: left"
          >리합니다. 반적으로 안정적인 투자 전략을 취해 다양한 자산에 투자하며,
          상대적으로 안정적</span
        >
        <span style="display: block; text-align: left"
    ...
    >
      ...
      >
        <h3 style="margin: 0">
          '<span style="color: green">{{ searchQuery }}</span
          >' 검색결과
        </h3>
